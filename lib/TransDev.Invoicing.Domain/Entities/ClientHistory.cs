...
public record ClientHistory : HistoryEntityBase
{
    ...
    public virtual Client Parent { get; init; }
    public long PrimarySystemAddressId { get; init; }
    public virtual SystemAddress PrimaryAddress { get; init; }
    public long BillingSystemAddressId { get; init; }
    public virtual SystemAddress BillingAddress { get; init; }
    public int PrimaryContactId { get; init; }
    public virtual Contact PrimaryContact { get; init; }
    public int PrimaryBillingContactId { get; init; }
    public virtual Contact PrimaryBillingContact { get; init; }
